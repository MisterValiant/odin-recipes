...
document.querySelector('.background-img').style.backgroundImage='url(../images/mondstadt-recipe-day.webp)';
...
<div class="card-bottom">
    ...
    <div class="btn-container">
        <button
            onclick="window.open('https://www.masala.tv/moroccan-grilled-fish-brochettes-dawat-chef-abida-baloch/')"
            class="recipe-btn"><i class="bi bi-search"></i> &nbsp;View real recipe</button>
    </div>
</div>
</div>`;
